...
//////////////////////////////////////////////////////////////////////////////////
// Objective:   Trying to understand the soft AP library and how it can be used //
//////////////////////////////////////////////////////////////////////////////////
...
void setupWiFi()
{
  ...
  Serial.print("Mac Addr Length: ");
  Serial.println(WL_MAC_ADDR_LENGTH);
  char MAC_char[18];

  // checking to see how the mac address is created....
  ...
  Serial.print("Polished mac ID: ");
  Serial.println(macID);
  
  macID.toUpperCase();
  String AP_NameString = "Hive Tech: " + macID;
